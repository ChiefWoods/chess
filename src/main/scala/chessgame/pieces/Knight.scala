...
class Knight(private val team: Team.Team, private val piecePosition: Int, private val isFirstMove: Boolean = true) extends Piece(team, KNIGHT, piecePosition, isFirstMove) {
